...
export const metadata = {
  title: 'Uses',
  description:
    'The physical things I use every day - hardware, desk setup, and favorite gear.',
}
                ...
                return (
                  <Wrapper
                    ...
                    className={`
                      ...
                      ${
                        item.link
                          ? 'hover:border-orange-500/30 hover:shadow-md cursor-pointer group transition-all duration-200'
                          : ''
                      }
                    `}
                  >
