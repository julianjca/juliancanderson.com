...
export const metadata = {
  title: 'Changelog',
  description:
    'A running log of updates, wins, lessons, and pivots in my life.',
}
      ...
      <main className="pt-28 pb-24">
        ...
        >
          ...
          <p className="text-xl text-black/60 leading-relaxed max-w-2xl">
            A running log of updates, wins, lessons, and pivots. More informal
            than a blog, more structured than Twitter.
          </p>
        </section>
