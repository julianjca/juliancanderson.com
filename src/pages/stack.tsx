...
export default function StackPage({ items }: StackPageProps) {
      ...
      <main className="pt-28 pb-24">
        ...
        >
          ...
          <p className="text-xl text-black/60 leading-relaxed max-w-2xl">
            The ideas, mental models, habits, and tools that power how I think and
            work. Not just tech—the full operating system.
          </p>
        </section>
