...
import { Layout, FloatingNav, Footer, Testimonials } from '../components'
      ...
      <main className="pt-28 pb-24">
        ...
        >
          ...
          <p className="text-xl text-black/60 leading-relaxed max-w-2xl">
            I help teams and founders build great products. Whether you need hands-on
            development, technical guidance, or a collaborator for something new.
          </p>
        </section>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h2 className="font-display text-xl mb-2">{service.title}</h2>
        ...
        >
          <div className="p-8 rounded-2xl bg-gradient-to-br from-orange-50 to-amber-50 border border-orange-100 text-center">
            <h2 className="font-display text-2xl mb-3">Let's build something great</h2>
